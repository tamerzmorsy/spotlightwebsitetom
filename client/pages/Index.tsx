        ...
        <div className="relative z-20 text-center max-w-8xl mx-auto">
          ...
          <div className="flex justify-center mb-16">
            <Link to="/signup">
              <Button
                size="lg"
                className="bg-electric-blue text-midnight-black hover:bg-cyan-400 font-semibold text-xl px-12 py-6 rounded-full transition-all duration-300 hover:scale-105"
              >
                Create Free Account
              </Button>
            </Link>
