        ...
        <div className="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            <div className="bg-[#121418] rounded-3xl overflow-hidden relative h-96">
              {/* Educational Impact & Alumni Engagement Dashboard */}
              <div className="absolute inset-0 flex items-center justify-center p-4">
                <img
                  src="https://cdn.builder.io/api/v1/image/assets%2Ff9a2587e1b874b6e9d34bfb6b703b455%2Fce4d9b082a3c41578d10f468d20ad664?format=webp&width=800"
                  alt="Educational Impact & Alumni Engagement Analytics"
