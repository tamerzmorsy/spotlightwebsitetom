...
const MyStats = () => {
  ...
  const [badges, setBadges] = useState<Badge[]>([
    // Earned badges
    {
      id: "streak-star",
      name: "Streak Star",
      description: "Maintain a 7-day reading streak and show your consistency",
    ...
    },
    {
      id: "campus-champ",
      name: "Campus Champ",
      description: "Share 10 articles with your campus community",
    ...
    },
    {
      ...
      description: "Explore 5 different news topics and broaden your horizons",
      icon: <MapPin className="w-8 h-8" />,
      category: "reading",
      requirement: "Explore 5 topics",
      earned: true,
    ...
    },
    {
      id: "challenge-boss",
      name: "Challenge Boss",
      description: "Complete 3 reading challenges like a true champion",
    ...
    // Available badges (not earned)
    {
      id: "share-slinger",
      name: "Share Slinger",
      description: "Share 20 articles and become a content curator",
      icon: <Share2 className="w-8 h-8" />,
      category: "social",
      requirement: "Share 20 articles",
      progress: 12,
      maxProgress: 20,
      earned: false,
      rarity: "rare"
    },
    {
      id: "knowledge-king",
      name: "Knowledge King",
      description: "Read 100 articles and crown yourself with wisdom",
    ...
    },
    {
      id: "speed-reader",
      name: "Speed Reader",
      description: "Read 10 articles in a single day - lightning fast!",
    ...
    {
      id: "diversity-dynamo",
      name: "Diversity Dynamo",
      description: "Read from 10 different publications and diversify your feed",
      icon: <Globe className="w-8 h-8" />,
      category: "reading",
      requirement: "Read from 10 publications",
      progress: 7,
      maxProgress: 10,
      earned: false,
      rarity: "rare"
    },
    {
      ...
      description: "Refer 5 friends to join the news revolution",
    ...
    },
    {
      id: "news-ninja",
      name: "News Ninja",
      description: "Read silently for 30 minutes straight - stealth mode activated",
      icon: <Eye className="w-8 h-8" />,
      category: "special",
      requirement: "30 minutes silent reading",
      progress: 18,
      maxProgress: 30,
      earned: false,
      rarity: "legendary"
